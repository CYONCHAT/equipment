# Contrato do módulo — equipment

Este documento resume o contrato local de equipment. O contrato transversal de headers e webhooks está em [communication-contract.md](communication-contract.md).
